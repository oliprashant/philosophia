...
import { z } from 'zod';
import { resolveGenreFilter } from '@/lib/forms';
...
export async function GET(req: NextRequest) {
  ...
  const form = searchParams.get('form') || searchParams.get('formSlug') || '';
  ...
  const genreFilter = resolveGenreFilter(form || null, genre || null);
